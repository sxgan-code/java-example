...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
    ...
    <g id="ic_gallery_blur_actived" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <path
          ...
          transform="translate(12.000000, 11.999292) scale(1, -1) translate(-12.000000, -11.999292) "/>
    </g>
  </svg>
</template>
