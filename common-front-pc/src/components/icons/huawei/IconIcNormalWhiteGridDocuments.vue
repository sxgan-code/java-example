  ...
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="281px" height="320px"
    ...
    <g id="页面-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <path
          ...
          id="矩形备份-81" fill="#A2C9FF"/>
      <g id="编组-249" transform="translate(65.428571, 146.000000)" fill="#FFFFFF">
        <rect id="矩形" x="0" y="0" width="150" height="16" rx="8"/>
        <rect id="矩形备份" x="0" y="48" width="150" height="16" rx="8"/>
        <rect id="矩形备份-2" x="0" y="96" width="91" height="16" rx="8"/>
      </g>
    </g>
  </svg>
</template>
