...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="12px" height="24px"
    ...
    <g id="Public/ic_public_arrow_left" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <mask id="mask-2" fill="white">
        <use xlink:href="#path-1"/>
      </mask>
      <use id="路径" fill="#000000" fill-rule="nonzero"
           transform="translate(6.371320, 11.999964) scale(-1, 1) translate(-6.371320, -11.999964) "
           xlink:href="#path-1"/>
    </g>
  </svg>
</template>
